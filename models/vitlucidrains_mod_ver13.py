...
class Attention(nn.Module):
    def __init__(self, dim, heads=8, dim_head=64, dropout=0., alpha=0.1):
        super().__init__()
    ...
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, dropout=0.):
        ...
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                Attention(dim, heads=heads, dim_head=dim_head, dropout=dropout, alpha=0.1),
...
class vitlucidrains_mod_ver13(nn.Module):
